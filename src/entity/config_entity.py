...
class DataTransformationConfig:
    ...
    tranformed_object_file_path: str = os.path.join(data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR, PREPROCESSING_OBJECT_FILE_NAME)
...
class ModelTrainerConfig:
    ...
    _fit_intercept = MODEL_TRAINER_FIT_INTERCEPT
...
@dataclass
class DiabetesPredictionConfig:
