...
class TargetValueMapping:
    ...
    def _asdict(self):
        """
        This converts class instance's/object's attribute into dictionary.
        Its like a helper method to fetch all mappings as key-value pairs.
        """
        return self.__dict__
    
    def reverse_mapping(self):
        """
        This method reverse the mapping done by _asdict() i,e swapping keys and values.
        For instance it would convert {'yes': 0, 'no': 1} into {0: 'yes', 1: 'no'}.
        """
