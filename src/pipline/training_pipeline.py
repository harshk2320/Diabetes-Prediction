...
from src.entity.config_entity import (ModelTrainerConfig, DataIngestionConfig, DataValidationConfig, DataTransformationConfig, ModelEvaluationConfig)
...
class TrainPipeline:
    ...
    def start_model_evaluation(self, data_ingestion_artifact: DataIngestionArtifact
        ...
        """
        This method of TrainPipeline class is responsible fro starting model evaluation.
        """
        try:
